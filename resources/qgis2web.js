...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [360595.573400, 775638.619689, 402501.341780, 809821.753611], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32631',
            extent: [368461.044496, 787624.616000, 395075.687785, 804188.408500],
            units: 'm'})
    })
});
...
map.getView().fit([360595.573400, 775638.619689, 402501.341780, 809821.753611], map.getSize());
