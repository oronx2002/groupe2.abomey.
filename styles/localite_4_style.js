...
var style_localite_4 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var offsetY = 3;
    var placement = 'point';
    if (feature.get("nom_loc") !== null) {
        labelText = String(feature.get("nom_loc"));
    }
    
        function rules_localite_4(feature, value) {
            var context = {
                feature: feature,
                variables: {}
            };
            // Start of if blocks and style check logic
            if (exp_localite_4rule0_eval_expression(context)) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    else if (exp_localite_4rule1_eval_expression(context)) {
                      return [ new ol.style.Style({
        ...
        image: new ol.style.Circle({radius: 0.7 + size,
        ...
        var style = rules_localite_4(feature, value);
        ;
